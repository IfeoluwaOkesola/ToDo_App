...
let TodoRepository = class TodoRepository extends base_repositpry_1.BaseRepository {
    constructor(todoModel, TodoRepo, entityManager) {
        super(todoModel);
        this.todoModel = todoModel;
        this.TodoRepo = TodoRepo;
        this.entityManager = entityManager;
        this.TodoRepo = this.entityManager.getRepository(todo_entity_1.Todo);
    }
    async save(data) {
