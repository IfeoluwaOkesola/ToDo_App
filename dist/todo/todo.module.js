...
exports.TodoModule = TodoModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [todo_service_1.TodoService, todo_repository_1.TodoRepository, typeorm_2.Repository],
        exports: [todo_repository_1.TodoRepository, todo_service_1.TodoService],
    })
], TodoModule);
